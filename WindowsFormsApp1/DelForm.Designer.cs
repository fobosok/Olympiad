namespace WindowsFormsApp1
{
	partial class DelForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "select olympiad year";
			// 
			// label2
			// 
			...
			this.label2.Text = "select sport name";
			// 
			// comboBox2
			// 
			...
			this.label3.Text = "select person first name";
			// 
			// comboBox3
			// 
			this.comboBox3.FormattingEnabled = true;
			this.comboBox3.Location = new System.Drawing.Point(12, 121);
			...
			this.label4.Text = "select person result";
			// 
			// comboBox4
			// 
			this.comboBox4.FormattingEnabled = true;
			this.comboBox4.Location = new System.Drawing.Point(12, 172);
			...
			// button5
			// 
			this.button5.Location = new System.Drawing.Point(116, 170);
